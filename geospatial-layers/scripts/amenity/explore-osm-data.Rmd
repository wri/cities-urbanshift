...
OSM is a global open access mapping project, which is free and under the [ODbLlicense](https://www.openstreetmap.org/copyright). See the [OSM wiki](https://wiki.openstreetmap.org/wiki/Contribute_map_data) to find out how to contribute to the world’s open geographical data commons. 

# The Overpass API

The [oevrpass API](https://www.overpass-api.de/) is a read-only API that serves up custom selected parts of the OSM map data.
